    ...
    <div class="container"><a class="navbar-brand"><img src="images/optimus-logo.png"></a>
        ...
        <div id="my-nav" class="collapse navbar-collapse">
            ...
            <form class="form-inline my-2 my-lg-0">
                <a href="admin_user_login" class="btn btn-outline-dark my-2 my-sm-0 mr-3 text-uppercase">login</a> 
                <a href="signup" class="btn btn-info my-2 my-sm-0 text-uppercase">sign up</a>
            </form>
        </div>
    </div>
</nav>
