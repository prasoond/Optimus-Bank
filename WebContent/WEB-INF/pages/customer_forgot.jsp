                   ...
                   <div>${no_such_account}</div>
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <button class="btn btn--radius-2 btn--red" type="submit">Email me a Reset Link.</button>
                          </div>

                    <div>An Email wil be sent to your registered email adress.
                        <br>This Link will help you to reset your password </div>
            </form>
                </div>
            </div>
        </div>
